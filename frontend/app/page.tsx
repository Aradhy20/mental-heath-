...
export default function LandingPage() {
  ...
  return (
    <div className="dark bg-[#080816] text-[#eeeef5] min-h-screen font-sans overflow-x-hidden selection:bg-brand-violet/30 selection:text-white relative">
      ...
      <div className="absolute top-[30vw] right-[-10vw] w-[40vw] h-[40vw] rounded-full bg-gradient-to-bl from-brand-rose/8 via-brand-purple/5 to-transparent filter blur-[140px] z-0 pointer-events-none" />
      <div className="absolute bottom-[10vw] left-[-5vw] w-[35vw] h-[35vw] rounded-full bg-gradient-to-tr from-brand-teal/8 to-transparent filter blur-[110px] z-0 pointer-events-none" />
