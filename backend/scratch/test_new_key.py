...
voice_id = "jUjRbhZWoMK4aDciW36V" # Anika

client = ElevenLabs(api_key=api_key)
try:
    print("Testing new API key with voice ID...")
    ...
    print(f"SUCCESS! Generated {len(audio_data)} bytes using new API key and voice Anika!")
